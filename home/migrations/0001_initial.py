    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assegnato_a', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promemoria_assegnati', to=settings.AUTH_USER_MODEL, verbose_name='Assegnato a')),
                ('creato_da', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promemoria_creati', to=settings.AUTH_USER_MODEL, verbose_name='Creato da')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allegato', models.FileField(blank=True, null=True, upload_to='messaggi/', verbose_name='Allegato')),
                ('destinatario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messaggi_ricevuti', to=settings.AUTH_USER_MODEL, verbose_name='Destinatario')),
                ('mittente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messaggi_inviati', to=settings.AUTH_USER_MODEL, verbose_name='Mittente')),
            ],
            options={
